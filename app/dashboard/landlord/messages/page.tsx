...
export default function LandlordMessagesPage() {
  ...
  return (
    <div className="space-y-8">
        ...
        <div className="relative">
          <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-6">
            ...
            <div className="flex-1">
              <h1 className="text-2xl md:text-3xl font-bold gradient-text">Messages & Communications</h1>
              <p className="text-muted-foreground text-base md:text-lg">Stay connected with your tenants and manage all communications.</p>
            </div>
            <div className="flex items-center gap-3">
              <Select value={activeFilter} onValueChange={setActiveFilter}>
                <SelectTrigger className="w-[140px] glass border border-border/50 rounded-xl">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-orange-600">{conversations.filter(c => c.unread > 0).length}</p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-red-600">{conversations.filter(c => c.status === 'urgent').length}</p>
              </div>
      ...
      {/* Main Chat Interface */}
      <div className="grid h-[calc(100vh-28rem)] grid-cols-1 gap-6 lg:grid-cols-7">
        {/* Conversations List */}
